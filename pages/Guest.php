...
<body>
    ...
    <div id="content">
        ...
        while($d = mysqli_fetch_array($data)){
            ...
            $rating=mysqli_query($conn, "SELECT TRUNCATE(AVG(RatingScore), 1) as averagescore FROM orderheader od JOIN shop s ON od.ShopID=s.ShopID WHERE s.ShopID LIKE '".$d['ShopID']."' AND OrderStatus=3")->fetch_assoc()['averagescore'];
